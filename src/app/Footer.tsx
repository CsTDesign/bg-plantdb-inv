...
export default function Footer() {
  return (
    <footer className="bg-secondary lg:pt-24 py-10 sm:pt-16">
      <div className="lg:px-8 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="gap-x-12 gap-y-16 grid grid-cols-2 lg:grid-cols-6 md:col-span-3">
          <div className="col-span-2 lg:col-span-2 lg:pr-8 md:col-span-3">
            <div className="font-bold text-2xl">Nurser-E</div>
            <p className="leading-relaxed mt-7 text-base text-muted-foreground">
              The Professionals at Baxter Gardens - Where Quality is Foremost since 1971.
            </p>

            <ul className="flex items-center mt-9 space-x-3">
              <li>
                <a
                  className="bg-foreground duration-200 flex focus:bg-primary hover:bg-primary items-center justify-center rounded-full size-7 text-background transition-all"
                  href="#"
                  title=""
                >
                  <svg
